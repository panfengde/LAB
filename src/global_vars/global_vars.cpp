...
void base_init()
{
    auto addName = LabEleTool::createLabEleString(string("go"));
    // string addName = "temp";
...
void number_init()
{
    ...
    Lab_Ptr addName = LabEleTool::createLabEleString(string("temp"));
...
void global_env_init()
{
    ...
    auto addName = (LabEleTool::createLabEleString(string("+")));
    ...
    auto subtract_name = (LabEleTool::createLabEleString(string("-")));
    ...
    auto equal_name = (LabEleTool::createLabEleString(string("=")));
